...
def get_flops_pytorch(model, input_res,
    ...
    if print_per_layer_stat:
        model_repr = print_model_with_flops(
            flops_model,
            flops_count,
            params_count,
            save_only=save_only,
    ...
    return flops_count, params_count, model_repr
...
def print_model_with_flops(model, total_flops, total_params, save_only=True, flops_units='GMac',
